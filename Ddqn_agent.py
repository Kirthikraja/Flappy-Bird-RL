...
class DoubleDQNAgent:
    def __init__(self, state_dim, action_dim, memory_size=50000, batch_size=256, gamma=0.99,
                 lr=0.0000501, epsilon=1.0, epsilon_decay=0.995, epsilon_min=0.01, update_target_every=300,
